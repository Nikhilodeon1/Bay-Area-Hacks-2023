...
@app.route('/course69', methozds=['POST'])
def course():
    ...
    #coursera, and everything else===============================================================
    with urllib.request.urlopen('http://trifam.net/~shish/hackathons/bay_area_hacks23/collective.json') as response2:
        html2 = dict(response2.read())
        dict1 = html2[course1]
        link4 = dict1['link']
        name5 = dict1['name']
        duration3 = dict1['duration']
        learners = dict1['learners']
    ...
    return render_template('course.html', duration=duration2, link=link2, name=name3, jdsfghjklghfjkghlskdjfghlsjkdfds=jdsfghjklghfjkghlskdjfghlsjkdfds, link=link, html2=html2, link4=link4, name5=name5, duration3=duration3, learners=learners)
